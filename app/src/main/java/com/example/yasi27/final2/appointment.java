...
//        setAlarm(c);
        ...
        txtTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timepick = new TimePickerDialog(appointment.this, new TimePickerDialog.OnTimeSetListener() {
        ...
        txtDate.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                DatePickerDialog datepicker = new DatePickerDialog(appointment.this, new DatePickerDialog.OnDateSetListener() {
